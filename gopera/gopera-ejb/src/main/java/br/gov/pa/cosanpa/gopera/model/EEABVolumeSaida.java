...
@Entity
@SequenceGenerator(name="sequence_eeab_volume_saida", sequenceName="sequence_eeab_volume_saida", schema="operacao", initialValue=1, allocationSize=1)
...
public class EEABVolumeSaida implements Serializable{
	...
	@Column(name="eabs_id", unique=true, nullable=false, precision=3, scale=0)		
