...
@Entity
@SequenceGenerator(name="sequence_eeab_volume_entrada", sequenceName="sequence_eeab_volume_entrada", schema="operacao", initialValue=1, allocationSize=1)
...
public class EEABVolumeEntrada implements Serializable{
	...
	@Column(name="eabe_id", unique=true, nullable=false, precision=3, scale=0)		
