...
@Entity
@SequenceGenerator(name="sequence_rso_volume", sequenceName="sequence_rso_volume", schema="operacao", initialValue=1, allocationSize=1)
...
public class RSOVolume implements Serializable{
	...
	@Column(name="rsov_id", unique=true, nullable=false, precision=3, scale=0)		
    ...
    @Column(name="rsov_tmultimaalteracao", nullable=false, insertable=false, columnDefinition="timestamp default current_timestamp")
    @Temporal(TemporalType.TIMESTAMP)
