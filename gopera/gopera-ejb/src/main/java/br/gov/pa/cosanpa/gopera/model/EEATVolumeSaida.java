...
@Entity
@SequenceGenerator(name="sequence_eeat_volume_saida", sequenceName="sequence_eeat_volume_saida", schema="operacao", initialValue=1, allocationSize=1)
...
public class EEATVolumeSaida implements Serializable{
	...
	@Column(name="eats_id", unique=true, nullable=false, precision=3, scale=0)		
