...
public class UnidadeConsumidoraBean extends BaseBean<UnidadeConsumidora> {
	...
	@EJB
	private IUnidadeConsumidora fachada;
	...
	private void iniciarLazy(){
		if (listaDados == null) {  
			listaDados = new LazyDataModel<UnidadeConsumidora>() {
				...
				@Override
				public List<UnidadeConsumidora> load(int startingAt, int maxPerPage, String sortField, SortOrder sortOrder, Map<String, String> filters) {
					try {					
