...
import br.gov.pa.cosanpa.gopera.model.RSOHorasCMB;
...
public class RsoHorasBean extends BaseBean<RSOHoras> {
	...
	@EJB
	private IRSOHoras fachada;
	@EJB
	private IRSO fachadaRSO;	
	@EJB
	...
	private void iniciarLazy(){
		if (listaConsumo == null) {  
			listaConsumo = new LazyDataModel<RSOHoras>() {
				...
				@Override
				public List<RSOHoras> load(int startingAt, int maxPerPage, String sortField, SortOrder sortOrder, Map<String, String> filters) {
					try {					
