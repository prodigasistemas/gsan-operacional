...
This will deploy `target/gopera.ear`.
 
The application will be running at the following URL <http://localhost:8080/gopera/>.
...
Após isso, verificar a pasta de repositório local do maven para localizar o arquivo EAR.
Enviar este arquivo para o servidor.     