...
public class HorasBO {
    ...
    public List<LancamentoPendente> obterHorasPendentes() {
        ...
        if (dias != null && dias.getValor() != null) {
            ...
            List<EstacaoOperacional> estacoes = estacaoRepositorio.listarEstacoesComHoraPendente(referencia, TipoUnidadeOperacional.EAB);
            estacoes.addAll(estacaoRepositorio.listarEstacoesComHoraPendente(referencia, TipoUnidadeOperacional.EAT));
            estacoes.addAll(estacaoRepositorio.listarEstacoesComHoraPendente(referencia, TipoUnidadeOperacional.ETA));
