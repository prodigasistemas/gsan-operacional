...
import br.gov.servicos.operacao.RelatorioProdutoQuimicoRepositorio;
...
public class RelatorioGerencialBean extends BaseRelatorioBean<RelatorioGerencial> {
	...
	@EJB
	private RelatorioProdutoQuimicoRepositorio fachadaRel;
	
	@EJB
	private ConsumoETARepositorio fachadaConsumoETA;
	
	@EJB
	private ConsumoEATRepositorio fachadaConsumoEAT;
