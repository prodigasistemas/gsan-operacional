...
import br.gov.model.operacao.ETEVolume;
...
import br.gov.servicos.operacao.EteRepositorio;
import br.gov.servicos.operacao.EteVolumeRepositorio;
...
public class EteVolumeBean extends BaseBean<ETEVolume> {
	...
	@EJB
	private EteVolumeRepositorio fachada;
	
	@EJB
	private EteRepositorio fachadaETE;
